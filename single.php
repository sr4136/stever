		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			...
			<main id="main" class="m-all t-2of3 d-5of7 cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
				<article id="post-not-found" class="hentry cf">
					...
					<section class="entry-content">
						<?php if( $technical_details || $other_credit ): ?>
			...
			<div id="sidebar1" class="sidebar m-all t-1of3 d-2of7 last-col cf view-options" role="complementary">
				...
				<?php if( $link_video ): ?>
					<div class="widget">
						<h3>Video:</h3>
						<a data-fancybox href="https://youtu.be/<?php echo( $link_video ); ?>">
							<img src="https://ytimg.googleusercontent.com/vi/<?php echo( $link_video ); ?>/mqdefault.jpg" />
						</a>
					</div>
				<?php endif; ?>
